var scene, camera, controls, fieldOfView, aspectRatio, nearPlane, farPlane, shadowLight, backLight, light, renderer, planeAspectRatio, container;
//SCENE
...
class RangeSlider {
	...
	*/ initRange(range) {
        ...
        /* circular */ if (circular) {
            ...
            this.updateCircle();
        } else range.addEventListener('input', ()=>{
            return this.updateRange();
        });
        /* TODO: Send init event ? */ range.dispatchEvent(new Event('input'));
    }
    /**
	* @function rotate
	* @param {Number} x
	...
	*/ updateCircle(start1) {
        ...
        if (start1) this.range.value = Math.ceil(end / rad);
...
/* Helper methods */ function stringToType(obj) {
...
document.getElementById('my-modal-2').onclick = function() {
    recognition.start();
    document.getElementById("modal-info").textContent = "Ready to Receive a Command...";
...
//# sourceMappingURL=project.2f24f36f.js.map
